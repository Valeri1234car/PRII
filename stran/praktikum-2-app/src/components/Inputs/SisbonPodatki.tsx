...
const SisbonPodatki = () => {
    ...
    return (
        <div className="vnosItem">
            <h2 className="mb-4 text-success fw-bold">PODATKI SISBON (V EUR)</h2>
            <div className="vnosnaPolja">
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" name="sisbonNeodplacanDelObvezost" value={podatkiState.sisbonNeodplacanDelObvezost} onChange={HandleChange} style={{ borderColor: 'navy', color: 'navy' }} />
                </div>
                <div className="mb-3">
                    <label htmlFor="sisbonZapadliDolg" className="form-label">SISBON - ZAPADLI DOLG:</label>
                    <input type="text" className="form-control" name="sisbonZapadliDolg" value={podatkiState.sisbonZapadliDolg} onChange={HandleChange} style={{ borderColor: 'navy', color: 'navy' }} />
                </div>
                <div className="mb-3">
                    <label htmlFor="sisbonIzterjava" className="form-label">SISBON - IZTERJAVA:</label>
                    <input type="text" className="form-control" name="sisbonIzterjava" value={podatkiState.sisbonIzterjava} onChange={HandleChange} style={{ borderColor: 'navy', color: 'navy' }} />
                </div>
                <div className="mb-3">
                    <label htmlFor="sisbonIzvrsba" className="form-label">SISBON - IZVRŠBA:</label>
                    <input type="text" className="form-control" name="sisbonIzvrsba" value={podatkiState.sisbonIzvrsba} onChange={HandleChange} style={{ borderColor: 'navy', color: 'navy' }} />
                </div>
                <div className="mb-3">
